...
const Home = () => {
  ...
  return (
    ...
    <div class = "w-[200px] h-[100px] pl-5">
      <div className="border border-gray-500 border-opacity-50 bg-gray-200 bg-opacity-50 rounded-lg p-4 text-center">
                    <h1 className='text-2x0.5 font-bold text-white'>Forest Fire</h1>
                 </div>
  
    </div>
    <div class = "w-[200px] h-[50px] pl-5 ">
    <div className="border border-gray-500 border-opacity-50 bg-gray-200 bg-opacity-50 rounded-lg p-4 text-center">
                    <h1 className='text-2x0.5 font-bold text-white'>Water Pollution</h1>
                 </div>
    </div>
    <div class = "w-[200px] h-[100px] pl-5">
    <div className="border border-gray-500 border-opacity-50 bg-gray-200 bg-opacity-50 rounded-lg p-4 text-center">
                    <h1 className='text-2x0.5 font-bold text-white'>Solid Waste</h1>
                 </div>
    </div>
    <div class = "w-[200px] h-[100px] pl-5">
      <div className="border border-gray-500 border-opacity-50 bg-gray-200 bg-opacity-50 rounded-lg p-4 text-center">
                    <h1 className='text-2x0.5 font-bold text-white'>Fire Hazard</h1>
                 </div>
 ...
 Users can upload photos of accidents via the EcoWatch web application. The system processes these images and forwards the reports to the relevant emergency services and local authorities.
</p>
    </div>
